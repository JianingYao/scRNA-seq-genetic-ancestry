...
PCA_FILE="/project/gazal_569/jianing/sc-RNA_ancestry/scripts/Analysis/00_TGP/Results/TGP_PLINK"

# step 1: convert vcf into plink format and QC the data
DIR="/project/gazal_569/jianing/sc-RNA_ancestry/scripts/Analysis/01_Ancestry/Results/${STUDY}"
...
Rscript /project/gazal_569/jianing/sc-RNA_ancestry/scripts/Analysis/01_Ancestry/create_pop_file.r $STUDY
