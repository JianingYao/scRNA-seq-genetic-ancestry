...
num_clusters = 10
info = read.table("./Results/myinfo.split.txt",h=T)
...
for (anc in list_anc){
    ...
    for (REGION in list_pop){
        for (i in 1:num_clusters){
            data = read.table(paste0("./Results/",STUDY,"/pcaRF_results/",anc,".",REGION,".",i,".",STUDY,".pca_randomforest.txt"),h=T)
...
write.table(pca_randomforest.anc.accuracy.STUDY,file=paste0("./Results/", STUDY, "/final_outs/", STUDY, "_RF_anc_accuracy.txt"),col.names=T,row.names=T,quote=F,sep="\t")
write.table(pca_randomforest.pop.accuracy.STUDY,file=paste0("./Results/", STUDY, "/final_outs/", STUDY, "_RF_pop_accuracy.txt"),col.names=T,row.names=T,quote=F,sep="\t")

#admixture
myinfo = read.table("./Results/myinfo.split.txt",h=T)
...
for (anc in list_anc){
    anc_info = subset(info,info$myREG==anc)
    list_pop = sort(unique(anc_info$POP))
    data = read.table(paste0("./Results/",STUDY,"/admixture_results/",STUDY,".",anc,".",list_pop[1],".1.txt"),h=F)
    ...
    for (REGION in list_pop){
        for (i in 1:num_clusters){
            data = read.table(paste0("./Results/",STUDY,"/admixture_results/",STUDY,".",anc,".",REGION,".",i,".txt"),h=F)
...
write.table(admixture.anc.accuracy.STUDY,file=paste0("./Results/", STUDY, "/final_outs/", STUDY, "_admixture_anc_accuracy.txt"),col.names=T,row.names=T,quote=F,sep="\t")
write.table(admixture.pop.accuracy.STUDY,file=paste0("./Results/", STUDY, "/final_outs/", STUDY, "_admixture_pop_accuracy.txt"),col.names=T,row.names=T,quote=F,sep="\t")
...
for (anc in list_anc){
    ...
    for (REGION in list_pop){
        for (i in 1:num_clusters){
            data = read.table(paste0("./Results/",STUDY,"/pca_results/",anc,".",REGION,".",i,".",STUDY,".pca_center.txt"),h=T)
            data.full[rownames(data),colnames(data)] = as.matrix(data.full[rownames(data),colnames(data)]+data[rownames(data),colnames(data)])
        }
    }
...
anc.accuracy.STUDY
pop.accuracy.STUDY
write.table(anc.accuracy.STUDY,file=paste0("./Results/", STUDY, "/final_outs/", STUDY, "_pca_anc_accuracy.txt"),col.names=T,row.names=T,quote=F,sep="\t")
write.table(pop.accuracy.STUDY,file=paste0("./Results/", STUDY, "/final_outs/", STUDY, "_pca_pop_accuracy.txt"),col.names=T,row.names=T,quote=F,sep="\t")
