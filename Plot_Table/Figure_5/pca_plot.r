...
if (STUDY == 'HormoneRegulatedNetworksBreast') {
  ...
  dev.off()
} else if (STUDY == 'HumanCellLandscape') {
  x1=c(dataTGP$V3,mydata$V3); y1=c(-dataTGP$V4,-mydata$V4)
  x2=c(dataTGP$V5,mydata$V5); y2=c(dataTGP$V6,mydata$V6)
  pdf(paste0(DATA_DIR,"/", STUDY,"/PCA_results/",STUDY,".pca.pdf"),width=8,height=4)
  split.screen(c(1,2))
  ...
  screen(2); plot(dataTGP$V5,dataTGP$V6 ,col=as.character(info$Color),pch=info$PCH,xlab="PC3",ylab="PC4",xlim=c(min(x2),max(x2)),ylim=c(min(y2),max(y2))); points(mydata$V5,mydata$V6,pch=16)
  dev.off()
} else if (STUDY == 'humanHeartFailureCellularLandscape_cell') {
  x1=c(dataTGP$V3,mydata$V3); y1=c(-dataTGP$V4,-mydata$V4)
  x2=c(dataTGP$V5,mydata$V5); y2=c(dataTGP$V6,mydata$V6)
  pdf(paste0(DATA_DIR,"/", STUDY,"/PCA_results/",STUDY,".pca.pdf"),width=8,height=4)
  split.screen(c(1,2))
  ...
  screen(2); plot(dataTGP$V5,dataTGP$V6 ,col=as.character(info$Color),pch=info$PCH,xlab="PC3",ylab="PC4",xlim=c(min(x2),max(x2)),ylim=c(min(y2),max(y2))); points(mydata$V5,mydata$V6,pch=16)
  dev.off()
} else if (STUDY == 'humanHeartFailureCellularLandscape_nuclei') {
  x1=c(dataTGP$V3,mydata$V3); y1=c(-dataTGP$V4,-mydata$V4)
  x2=c(dataTGP$V5,mydata$V5); y2=c(dataTGP$V6,mydata$V6)
  pdf(paste0(DATA_DIR,"/", STUDY,"/PCA_results/",STUDY,".pca.pdf"),width=8,height=4)
  split.screen(c(1,2))
  ...
  screen(2); plot(dataTGP$V5,dataTGP$V6 ,col=as.character(info$Color),pch=info$PCH,xlab="PC3",ylab="PC4",xlim=c(min(x2),max(x2)),ylim=c(min(y2),max(y2))); points(mydata$V5,mydata$V6,pch=16)
  dev.off()
} else if (STUDY == 'nasalMucosaLifespan') {
  x1=c(dataTGP$V3,mydata$V3); y1=c(dataTGP$V4,mydata$V4)
  x2=c(dataTGP$V5,mydata$V5); y2=c(-dataTGP$V6,-mydata$V6)
  pdf(paste0(DATA_DIR,"/", STUDY,"/PCA_results/",STUDY,".pca.pdf"),width=8,height=4)
  split.screen(c(1,2))
  ...
  screen(2); plot(dataTGP$V5,-dataTGP$V6 ,col=as.character(info$Color),pch=info$PCH,xlab="PC3",ylab="PC4",xlim=c(min(x2),max(x2)),ylim=c(min(y2),max(y2))); points(mydata$V5,-mydata$V6,pch=16)
  dev.off()
} else if (STUDY == 'NSCL_lesions_tumor_classification') {
  x1=c(dataTGP$V3,mydata$V3); y1=c(-dataTGP$V4,-mydata$V4)
  x2=c(dataTGP$V5,mydata$V5); y2=c(dataTGP$V6,mydata$V6)
  pdf(paste0(DATA_DIR,"/", STUDY,"/PCA_results/",STUDY,".pca.pdf"),width=8,height=4)
  split.screen(c(1,2))
