...
STAR_DIR="/project/gazal_569/jianing/sc-RNA_ancestry/scripts/HnsccImmuneLandscape/star_index_HnsccImmuneLandscape"
SOLO="CB_UMI_Simple"
...
--runDirPerm All_RWX \
--runThreadN $NODE \
--outFileNamePrefix "/scratch1/yaojiani/processed/HnsccImmuneLandscape/01_star_alignment/$FILE_OUT.step1." \
...
mv $DIR /scratch1/yaojiani/HnsccImmuneLandscape/