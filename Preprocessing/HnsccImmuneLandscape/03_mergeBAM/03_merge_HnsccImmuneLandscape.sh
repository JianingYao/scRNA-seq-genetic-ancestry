...
DIR="/scratch1/yaojiani/processed/HnsccImmuneLandscape/03_mergeBAM"
...
mv $FILE_LIST /project/gazal_569/jianing/sc-RNA_ancestry/scripts/HnsccImmuneLandscape/03_mergeBAM/donors/
