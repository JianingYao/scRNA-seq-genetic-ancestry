...
DIR_IN="/scratch1/yaojiani/processed/GompertsAirwatCfCells/05_SplitNCigarReads"
DIR_OUT="/scratch1/yaojiani/processed/GompertsAirwatCfCells/06_BaseRecalibrator"
