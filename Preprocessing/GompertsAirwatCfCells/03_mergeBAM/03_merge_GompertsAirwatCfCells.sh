...
DIR="/scratch1/yaojiani/processed/GompertsAirwatCfCells/03_mergeBAM"
...
mv $FILE_LIST /project/gazal_569/jianing/sc-RNA_ancestry/scripts/GompertsAirwatCfCells/03_mergeBAM/donors/
