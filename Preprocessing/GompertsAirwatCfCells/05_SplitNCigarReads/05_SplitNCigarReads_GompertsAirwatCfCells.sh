...
DIR_IN="/scratch1/yaojiani/processed/GompertsAirwatCfCells/04_MarkDuplicates"
DIR_OUT="/scratch1/yaojiani/processed/GompertsAirwatCfCells/05_SplitNCigarReads"
