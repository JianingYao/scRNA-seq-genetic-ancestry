...
DIR="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/03_mergeBAM"
...
mv $FILE_LIST /project/gazal_569/jianing/sc-RNA_ancestry/scripts/StemCellsInChronicMyeloidLeukemia/03_mergeBAM/donors/
