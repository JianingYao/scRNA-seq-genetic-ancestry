...
DIR_IN="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/08_HaplotypeCaller"
DIR_OUT="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/09_CombineGVCFs"
