...
DIR_IN="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/07_ApplyBQSR"
DIR_OUT="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/08_HaplotypeCaller"
