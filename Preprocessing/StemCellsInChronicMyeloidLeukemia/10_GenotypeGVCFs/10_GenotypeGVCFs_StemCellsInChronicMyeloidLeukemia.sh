...
DIR_IN="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/09_CombineGVCFs"
DIR_OUT="/project/gazal_569/jianing/sc-RNA_ancestry/scripts/StemCellsInChronicMyeloidLeukemia/10_GenotypeGVCFs"
