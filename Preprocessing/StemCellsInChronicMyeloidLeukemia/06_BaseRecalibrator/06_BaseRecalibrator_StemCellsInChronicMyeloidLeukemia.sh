...
DIR_IN="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/05_SplitNCigarReads"
DIR_OUT="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/06_BaseRecalibrator"
