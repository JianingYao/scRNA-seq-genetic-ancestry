...
DIR_IN="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/03_mergeBAM"
DIR_OUT="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/04_MarkDuplicates"
