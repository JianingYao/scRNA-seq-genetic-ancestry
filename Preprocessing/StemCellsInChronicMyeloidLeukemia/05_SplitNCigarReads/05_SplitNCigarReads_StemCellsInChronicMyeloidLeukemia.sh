...
DIR_IN="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/04_MarkDuplicates"
DIR_OUT="/scratch2/yaojiani/processed/StemCellsInChronicMyeloidLeukemia/05_SplitNCigarReads"
