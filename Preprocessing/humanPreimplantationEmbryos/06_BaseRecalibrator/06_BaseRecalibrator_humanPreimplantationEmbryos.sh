...
DIR_IN="/scratch2/yaojiani/processed/humanPreimplantationEmbryos/05_SplitNCigarReads"
DIR_OUT="/scratch2/yaojiani/processed/humanPreimplantationEmbryos/06_BaseRecalibrator"
