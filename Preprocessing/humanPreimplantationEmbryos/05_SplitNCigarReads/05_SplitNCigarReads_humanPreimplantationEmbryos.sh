...
DIR_IN="/scratch2/yaojiani/processed/humanPreimplantationEmbryos/04_MarkDuplicates"
DIR_OUT="/scratch2/yaojiani/processed/humanPreimplantationEmbryos/05_SplitNCigarReads"
