...
DIR_IN="/scratch2/yaojiani/processed/humanPreimplantationEmbryos/08_HaplotypeCaller"
DIR_OUT="/scratch2/yaojiani/processed/humanPreimplantationEmbryos/09_CombineGVCFs"
